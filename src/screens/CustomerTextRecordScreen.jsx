...
function CustomerTextRecordScreen({
  ...
  const isDisabled = isTooShort || isSummarizing;
        ...
        <section className="px-5">
          <div className="bg-white rounded-2xl px-4 py-3 shadow-sm border border-[#E6DFD6]">
            ...
            <p className="text-[14px] font-semibold text-gray-900">
              {selectedCustomerForRecord.name || '이름 미입력'}
...
export default CustomerTextRecordScreen;
