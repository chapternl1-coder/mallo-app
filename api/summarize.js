        ...
        messages: [
          {
            ...
            content:
              ...
              '}\n' +
              '중요 규칙:\n' +
              '1. sections의 content 배열은 반드시 문자열 배열이어야 해. 객체나 중첩 구조를 넣지 마.\n' +
              '2. 각 content 항목은 짧고 명확한 한 문장 또는 불릿 포인트 형태의 문자열이어야 해.\n' +
              '3. JSON 객체나 복잡한 구조를 content에 직접 넣지 말고, 필요한 정보는 문자열로 변환해서 넣어.\n' +
              '4. 가능한 섹션: "고객 기본 정보", "방문·예약 정보", "시술·관리 상세", "주의사항·홈 케어", "다음 방문·추천", "결제/매출" 등.\n' +
              '5. "고객 기본 정보" 섹션의 content는 ["이름: ○○○ / 전화번호: 010-0000-0000", "구분: 신규/기존", "고객 특징: ..."] 형식으로 3개 항목으로 구성.',
          },
          {
            role: 'user',
            content: sourceText,
